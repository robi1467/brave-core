...
export const URLS = {
  // TODO(petemill): production url should be https://brave-today-cdn.brave.com/feed.json
  braveTodayFeed: 'https://pcdn.brave.software/brave-today/feed.json',
  // TODO(petemill): production url should be https://brave-today-cdn.brave.com/sources.json
